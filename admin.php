                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="contactview.php" style="text-decoration: none;">Mails</a></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="volunteers.php" style="text-decoration: none;"> Volunteers</a></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a href="eventviewtable.php" style="text-decoration: none;">Attendance</a></div>
                        </div>
                        <div class="col">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="ocreg.php" style="text-decoration: none;">Open or close registration</a></div>
                    </div>
                    <div class="col-auto">
...
<img src="logo8.png" style="margin-left:150px;opacity: 90%;">
          </div>
