...
background: #4e73df;
color: #fff;
border: none;margin-left:15px;border-radius:5px;width: 40px;margin-bottom:2px;
      height: 30px;

outline: none;

}
.button:hover{box-shadow: 0 5px 25px rgba(0,0,0,.6);} 
...
.box:hover{box-shadow: 0 5px 25px rgba(0,0,0,.6);} 
</style>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Registered Students</h6>
                          <br>
              <form method="post" action="regviewbybatch.php">
  <div class="inputfield">
 <h5>Select Batch</h5><select name="batch" id="year" class="box" >
            </select>
<br><br>
