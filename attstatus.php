...
$result1 = mysqli_query($conn,"SELECT distinct * FROM attendance,student WHERE attendance.eventid=$eid and student.stid=attendance.stid and student.status='1' and student.mark>'0'");
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table id="attstatus" width="100%" cellspacing="0" cellpadding="15px">
                  <thead>
                    <tr>
...
{
?>
<form action="changeatt.php" method="post">
  <td> <?php echo ++$i; ?>  </td>  
 ...
 <td> <?php echo $row["name"]; ?>  </td>   
    ...
    <input type="hidden" name="status" value="<?php echo $row["attendance"]; ?>"/>
  <td><input type="submit" name="SubmitButton"value="change" class="button"/></td>
</form>   </td>
...
function myFunction() {
  ...
  table = document.getElementById("attstatus");
