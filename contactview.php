...
$result1 = mysqli_query($conn,"SELECT * FROM contact where view=0 order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table  id="contact" width="100%" cellspacing="4" cellpadding="14px">
                  <thead>
                    <tr>
                      <th>Sl.no</th>
...
{
?> 
<form method="post" action="mailstruct.php">
<td> <?php echo $row["id"]; ?> </td>   
<td> <?php echo $row["name"]; ?> <input type="hidden" name="name" value="<?php echo $row["name"]; ?>"> </td>
<td> <?php echo $row["email"]; ?> <input type="hidden" name="email" value="<?php echo $row["email"]; ?>"> </td> 
<td> <?php echo $row["message"]; ?> <input type="hidden" name="msg" value="<?php echo $row["message"]; ?>"> </td> 
<td> <?php echo $row["phone"]; ?>  </td> 
<td> <?php echo $row["time"]; ?>  </td> 
<td><input type="submit" value="reply">&nbsp&nbsp&nbsp&nbsp
</a><a href="contactdeleteprocess.php?email=<?php echo $row["email"]; ?>"> <i class="fas fa-trash" title="Delete"></i></a></td> 
