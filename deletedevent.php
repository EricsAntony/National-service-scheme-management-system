...
$result1 = mysqli_query($conn,"select  * from event where view=1 order by eid desc");
 ?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="deletedevent" width="100%" cellspacing="0" cellpadding="15">
                  <thead>
                    <tr>
...
?> <td> <?php echo $row["eid"]; ?>  </td>   
 ...
 <td> <?php echo $row["batch"]; ?>  </td> 
  ...
  <td> <a href="eundo.php?id=<?php echo $row["eid"]; ?>"><i class="fas fa-trash-restore" title="restore event"></i></a>
  </tr>  
<?php
}
?>
...
function myFunction() {
  ...
  table = document.getElementById("deletedevent");
