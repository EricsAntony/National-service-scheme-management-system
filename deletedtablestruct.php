...
$result1 = mysqli_query($conn,"SELECT distinct * from student,deleted where student.view=1 and student.stid=deleted.stid
 order by delid desc");
...
?> <td> <?php echo $row["stid"]; ?>  </td>   
 ...
 <td> <?php echo $row["batch"]; ?>  </td> 
  ...
  <td> <?php echo $row["aware"]; ?>  </td> 
  <td> <?php echo $row["time"]; ?>  </td> 
  <td> <a href="undoprocess.php?id=<?php echo $row["stid"]; ?>"><i class="fas fa-trash-restore" title="restore student"></i></a>
  </tr>  
<?php
}
?>
