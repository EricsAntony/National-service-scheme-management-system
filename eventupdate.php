...
$result1 = mysqli_query($conn,"SELECT * FROM event where view=0 order by eid desc");
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                  <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Search by event name..." aria-label="Search" aria-describedby="basic-addon2" id="myInput" onkeyup="myFunction()">
...
<td>
  <a href="eventedit.php?id=<?php echo $row["eid"]; ?>"><i class="fas fa-edit" title="edit"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 
  <a href="imgupload.php?id=<?php echo $row["eid"]; ?>" ><i class="fas fa-cloud-upload-alt" title="upload image"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp

  <a href="reportstruct.php?id=<?php echo $row["eid"]; ?>"  ><i class="fas fa-paste" title="generate report"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 

  <a href="attstatus.php?ename=<?php echo $row["ename"]; ?> & id=<?php echo $row["eid"]; ?>" ><i class="far fa-address-book" title="view attendance"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  <a href="deleteeventprocess.php?id=<?php echo $row["eid"]; ?>"  > <i class="fas fa-trash" title="Delete"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td> 
  </tr>  
<?php
}
?>
