          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="attendance" width="100%" cellspacing="0" cellpadding="10">
                  <thead>
                    <tr>
                      <th>Event ID</th>
                      <th>Event Name</th>
...
<td><a href="ATT2STRUCT.PHP?batch=<?php echo $row["batch"]; ?> & id=<?php echo $row["eid"]; ?>"> <img src="att.png" title="Mark attendance" style="width:32px;height:32px;"></a>
