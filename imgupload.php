...
<hr class="sidebar-divider my-0">
  ...
  $eid = $_REQUEST['id'];
 $result = mysqli_query($db, "SELECT * FROM images where image_text=$eid");

    while ($row = mysqli_fetch_array($result)) {
      echo "<div id='img_div'>";
        echo "<img src='images/".$row['image']."' style=width:60%; height:60%;>";
  ...
  <form method="POST" action="imgprocess.php" enctype="multipart/form-data">
    ...
    <input type="hidden" name="eid" value="<?php $eid = $_REQUEST['id']; echo $eid?>">
    <div>
    ...
    <div>
      ...
      <textarea 
        ...
        rows="4" 
        name="image_text" 
        placeholder="Say something about this image...(Optional)"
        style="resize: none;border: none;border-bottom: 2px solid #4e73df"></textarea>
    </div>
    <div>
      <br>
      <button type="submit" name="upload" style="background: #4e73df;
color: #fff;
border: none;
