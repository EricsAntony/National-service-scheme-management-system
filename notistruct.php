...
else
{
  ...
  $result1 = mysqli_query($conn,"SELECT * FROM student where view='0' and batch='$batch' AND STATUS='$status'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
              ...
              <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" id="search" onkeyup="myFunction()">
            ...
            <div class="container-fluid">
              ...
              <form method="post" action="notiprocess.php">
                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="noti" width="100%" cellspacing="0" cellpadding="14px">
                        <thead>
                          <tr>
                            <th>Sl.no</th>
                            <th>student id</th>
                         ...
                         <td>
                           <?php echo $row["email"]; ?>
                           <input type="hidden" name="email[<?php echo $i; ?>]" value="<?php echo $row["email"]; ?>" />
                         </td>
               ...
               <script>
                function myFunction() {
                  ...
                  table = document.getElementById("noti");
