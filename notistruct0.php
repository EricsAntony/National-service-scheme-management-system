...
<head>
<style>::-webkit-input-placeholder { /* Chrome/Opera/Safari */
  color: white;
}</style>
  <meta charset="utf-8">
...
<body>
<form method="post" action="notistruct.php">
<select name="batch" id="year" class="box" style="background: #4e73df;
      color: #fff;
      padding: 10px;
      width: 250px;
      height: 50px;
...
<select name="status" class="box" style="background: #4e73df;
      color: #fff;
      padding: 10px;
      width: 250px;
      height: 50px;
      ...
      outline: none;
      margin-left: 20px;">
    			  <option value="0">wating students</option>
    			  <option value="1">selected students</option>
     			 
            </select><br><br>
<input type="textarea" name="msg" placeholder="type message to be sent..."
class="box" style="background: #4e73df;
      color: #fff;
      padding: 10px;
      width: 250px;
      height: 50px;
      ...
      outline: none;
      margin-left: 20px;">
<input type="submit" value="go" style="background: #4e73df;
color: #fff;
border: none;
box-shadow: 0 5px 25px rgba(0,0,0,.6);
outline: none;
