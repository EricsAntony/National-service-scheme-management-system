...
$result1 = mysqli_query($conn,"SELECT * FROM student where batch='$batch' and rstatus=2 and view=0");
        ...
        <div class="modal-footer">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <a href="markstruct.php?batch=<?php echo $batch ?>" style="float: right; text-decoration: none;"><h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-folder-plus"></i>&nbsp &nbspAdd interview marks</h6></a>
            </div>
            <div class="card-body">
