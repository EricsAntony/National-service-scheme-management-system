...
$result1 = mysqli_query($conn,"SELECT * FROM student where view=0 and batch='$batch'and mark>0 ORDER by mark desc limit 100");
...
<form method="post" action="selprocess.php">
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Sorted Students</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table id="testrun" width="100%" cellspacing="0" cellpadding="15px">
                  <thead>
                    <tr>
                      <th>Sl.no</th>
                      <th>ID</th>
...
?> 
<td><?php echo $i;?></td>
<td> <?php echo $row["stid"]; ?> 
<input type="hidden" name="roll_no[<?php echo $i; ?>]" value="<?php echo $row["stid"]; ?>" />
<input type="hidden" id="<?php echo "present".$i;?>" name="attendance_status[<?php echo $i; ?>]" value="1" checked> 
 </td>   
...
?>
  ...
  <input type="submit" name="submit" value="Sort final list" />
...
function myFunction() {
  ...
  table = document.getElementById("testrun");
