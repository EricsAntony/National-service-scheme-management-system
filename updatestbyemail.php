...
if(!$conn)
{
 ...
 ?>
  ...
  <?php 
//$eid=$_REQUEST['id'];
  $sql = "select * from noti order by date desc";
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
         <li class="nav-item">
        <a class="nav-link" href="updatestbyemail.php">
          <i class="fas fa-pencil-alt"></i>
          <span>Update your details</span></a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="attstbyemail.php">
          ...
          <div id="content-wrapper" class="d-flex flex-column">
            ...
            Alerts Center
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="small text-gray-500"><?php echo $fetchRow['date']?></div>
                    <span class="font-weight-bold"><?php echo $fetchRow['message']?></span>
                  </div>
                </a>
 ...
 <div class="container-fluid">
  ...
  <form method="post" action="stedit.php">
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="dataTable" width="100%" cellspacing="0" cellpadding="10">
                  <thead>
                    <tr>
                      <th>Enter your email id</th>
                      <th><input type="text" name="email" required /></th>
                      <th><input type="submit" name="name" value="Go"required /></th>
                    </tr>
                    <tr>
