...
$result1 = mysqli_query($conn,"SELECT * FROM student where status=1 and batch='$batch'  and view=0");
        ...
        <div class="modal-footer">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Volunteers Of&nbsp&nbsp<?php echo $batch ;?>&nbsp&nbsp Batch</h6>
            </div>
            <div class="card-body">
 
              <div class="table-responsive">
                <table id="Volunteers" width="100%" cellspacing="0" cellpadding="14">
                  <thead>
                    <tr>
                      <th>Sl.no</th>
                      <th>ID</th>
...
<td><a href="edit.php?id=<?php echo $row["stid"]; ?>"><i class="fas fa-edit" title="edit"></i></a>&nbsp&nbsp&nbsp
 <a href="deletestruct.php?id=<?php echo $row["stid"]; ?>"> <i class="fas fa-trash" title="Delete"></i></a></td>  
  </tr>  
<?php
}
?>
...
function myFunction() {
  ...
  table = document.getElementById("Volunteers");
